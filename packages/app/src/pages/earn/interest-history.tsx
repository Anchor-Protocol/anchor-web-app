...
import InterestEarned, { InterestEarnedPeriod } from './interest-history/interest-earned'
...
const InterestHistory: React.FunctionComponent<InterestHistoryProps> = ({
  ...
  return (
    <Box>
      <section>
        <InterestEarned type={InterestEarnedPeriod.TOTAL} interestEarned={12313123}/>
      </section>
      <section>
        <Apy apy={9.37}/>
      </section>
