...
export const pickResult = <T extends object>(data: MantleResponseWithHeight<T>) => data.Result
export const pickContractResult = <Result extends object | string>(response: MantleContractResponse): Result => JSON.parse(response.Result as string)
