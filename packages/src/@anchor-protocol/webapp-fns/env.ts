  ...
  mainnet: {
    ...
    gas: {
      earnDeposit: {
        ...
        gasFee: 435398 as uUST<number>,
        fixedGas: 65310 as uUST<number>,
      },
      earnWithdraw: {
        description: 'Redeem stable',
        gasFee: 510103 as uUST<number>,
        fixedGas: 76516 as uUST<number>,
      },
      borrowBorrow: {
        description: 'Borrow stable',
        gasFee: 526291 as uUST<number>,
        fixedGas: 78944 as uUST<number>,
      },
      borrowRepay: {
        description: 'Repay stable',
        gasFee: 354424 as uUST<number>,
        fixedGas: 53164 as uUST<number>,
      },
      borrowProvideCollateral: {
        description: 'Deposit collateral/Lock collateral',
        gasFee: 651013 as uUST<number>,
        fixedGas: 97652 as uUST<number>,
      },
      borrowRedeemCollateral: {
        description: 'Unlockcollateral / WithdrawCollateral',
        gasFee: 882098 as uUST<number>,
        fixedGas: 132315 as uUST<number>,
      },
      bondMint: {
        description: 'bond',
        gasFee: 644776 as uUST<number>,
        fixedGas: 96717 as uUST<number>,
      },
      bondBurn: {
        description: 'burn',
        gasFee: 855973 as uUST<number>,
        fixedGas: 128396 as uUST<number>,
      },
      bondSwap: {
        description: 'instant burn',
        gasFee: 508640 as uUST<number>,
        fixedGas: 76296 as uUST<number>,
      },
      bondWithdraw: {
        description: 'Withdraw unbonded',
        gasFee: 203705 as uUST<number>,
        fixedGas: 30556 as uUST<number>,
      },
      bondClaim: {
        description: 'Claim Rewards',
        gasFee: 215845 as uUST<number>,
        fixedGas: 32377 as uUST<number>,
      },
      ancBuy: {
        description: 'ANC buy',
        gasFee: 255258 as uUST<number>,
        fixedGas: 38289 as uUST<number>,
      },
      ancSell: {
        description: 'ANC sell',
        gasFee: 284751 as uUST<number>,
        fixedGas: 42713 as uUST<number>,
      },
      ancGovernanceStake: {
        description: 'gov Stake',
        gasFee: 245964 as uUST<number>,
        fixedGas: 36895 as uUST<number>,
      },
      ancGovernanceUnstake: {
        description: 'gov Unstake',
        gasFee: 244501 as uUST<number>,
        fixedGas: 36676 as uUST<number>,
      },
      ancAncUstLpProvide: {
        description: 'provide liquidity',
        gasFee: 422905 as uUST<number>,
        fixedGas: 63436 as uUST<number>,
      },
      ancAncUstLpWithdraw: {
        description: 'withdraw liquidity',
        gasFee: 437050 as uUST<number>,
        fixedGas: 65558 as uUST<number>,
      },
      ancAncUstLpStake: {
        description: 'Lp staking',
        gasFee: 239347 as uUST<number>,
        fixedGas: 35903 as uUST<number>,
      },
      ancAncUstLpUnstake: {
        description: 'Lp unstaking',
        gasFee: 236455 as uUST<number>,
        fixedGas: 35469 as uUST<number>,
      },
      rewardsAllClaim: {
        description: 'claim all rewards',
        gasFee: 631053 as uUST<number>,
        fixedGas: 94658 as uUST<number>,
      },
      govCreatePoll: {
        description: 'CreatePoll',
        gasFee: 267601 as uUST<number>,
        fixedGas: 40141 as uUST<number>,
      },
      govVote: {
        description: 'Vote',
        gasFee: 193615 as uUST<number>,
        fixedGas: 29043 as uUST<number>,
      },
