...
export function ANCHOR_CONSTANTS(network: NetworkInfo): AnchorConstants2 {
  return {
...
export const ANCHOR_CONTRACT_ADDRESS2 = (
  network: NetworkInfo,
): AnchorContractAddress => {
...
//} => {
//  let addressMap: ExpandAddressMap;
//
...
//
//  console.log(
//    'env.ts..ANCHOR_CONTRACT_ADDRESS()',
