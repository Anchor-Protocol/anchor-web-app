...
export function EvmWalletDetailContentBase({
  chainId,
  connection,
  disconnectWallet,
  walletAddress,
...
EvmWalletDetailContentProps) {
  ...
  //   window.open(
  //     `https://finder.terra.money/${chainId}/account/${walletAddress}`,
  //     '_blank',
  //   );
...
export const EvmWalletDetailContent = styled(EvmWalletDetailContentBase)`
  > section {
    padding: 32px 28px;
