...
export interface RebondVUstTxParams {
  amount: string;
}

export function useRebondVUstTx() {
  ...
  const sendTx = useCallback(
    async (txParams: RebondVUstTxParams, writer: TerraTxProgressWriter) => {
      const result = await terraSdk.vesting.rebond(
      ...
      refetchQueries(ANCHOR_TX_KEY.VEST_REBOND);
