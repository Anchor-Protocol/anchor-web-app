export enum ANCHOR_TX_KEY {
  ...
  EXTEND_LOCK_PERIOD = 'EXTEND_LOCK_PERIOD',
  VOTE_FOR_GAUGE_WEIGHT = 'VOTE_FOR_GAUGE_WEIGHT',
  END_POLL = 'END_POLL',
}
...
export enum ANCHOR_QUERY_KEY {
  ...
  ANC_MY_VOTING_POWER = 'ANCHOR_QUERY_ANC_MY_VOTING_POWER',
  ...
  GOV_ANC_STAKING_APR = 'ANCHOR_QUERY_GOV_ANC_STAKING_APR',
  GOV_MY_POLLS = 'ANCHOR_QUERY_GOV_MY_POLLS',
  GOV_MY_ANC_STAKED = 'ANCHOR_QUERY_GOV_MY_ANC_STAKED',
  ...
  BLOCK = 'BLOCK',
  GAUGES = 'GAUGES',
  MY_GAUGE_VOTES = 'MY_GAUGE_VOTES',
  LOCAL_ANCHOR_CONTRACT_ADDRESS = 'LOCAL_ANCHOR_CONTRACT_ADDRESS',
  UNLOCK_PERIOD = 'UNLOCK_PERIOD',
  MY_LOCK_INFO = 'MY_LOCK_INFO',
